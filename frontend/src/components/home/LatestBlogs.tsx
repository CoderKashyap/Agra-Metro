                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 cursor-pointer items-center justify-items-center gap-6 py-6 px-3 md:px-1 w-full">
                    ...
                    <div className="max-w-sm hover:shadow-md bg-white border border-gray-200 hover:border-gray-300 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="px-5 pb-4">
                            <a >
                                <h5 className="font-quando my-3 text-md sm:text-lg font-semibold tracking-tight text-gray-600 dark:text-white">Noteworthy technology acquisitions 2021</h5>
                            </a>
                            ...
                            <a className="inline-flex justify-center items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Read more
